...
@Controller
public class EServices2MenuController {

    private static final Logger LOG = LoggerFactory.getLogger(EServices2MenuController.class);

    @RequestMapping(value = "/eServices2Menu.html", method = RequestMethod.GET)
    public String changePwdPage() {
        return "/eServices2/e-services-2-menu";
    }
