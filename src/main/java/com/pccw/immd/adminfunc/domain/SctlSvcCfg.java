...
public class SctlSvcCfg  implements Serializable {
    ...
    public SctlSvcCfg(String svcId, BigDecimal gst, BigDecimal mst, BigDecimal priority, String clawback, LocalDateTime lastAllotedDate, LocalDateTime lastReleaseDate, BigDecimal usedTicket, String svcDesc, String enable, String enableAudit, String successUrl, String busyUrl, String errorUrl, String suspendUrl) {
       this.svcId = svcId;
       this.gst = gst;
       this.mst = mst;
       this.priority = priority;
